...
<img src="assets/img/DTU_LOGO_WHITE.png" id="sitelogo" />
...
<div id="page4" class="pagee">
    <h1>ABOUT THE DATASET</h1>
    <h2>This dataset is from <img src="https://ourworldindata.org/owid-logo.svg" id="owid" width="30" height="22" /> Our world in Data and provides data on working hours.<br><br>These datasets provide a comprehensive perspective on the global workforce. They cover data ranging from annual working hours to GDP per capita, as well as information on work efficiency and employee benefits. By comparing data across different countries and periods, one can explore the relationship between labor hours, economic output, and productivity. Additionally, the datasets include information on vacation days and public holidays, which is crucial for understanding labor policies in various countries and their impact on workers’ quality of life. Overall, these datasets are important tools for understanding how labor patterns evolve and how they affect the broader socio-economic structure.</h2>
</div>

<div id="page5" class="pagee">
    <h1>WHY DID I CHOOSE THIS TOPIC?</h1>
    <img src="assets/img/Chekhov.png" id="chekhov" />
</div>


<div id="page7" class="pagee">
    <h2><br><br><br>"We must free people from the heavy physical labor," I said. "We must lighten their yokes, give them a breather, so they do not spend their entire lives by the stoves, troughs, and in the fields, but also have time to think about the soul, about God, and could broadly apply their spiritual abilities. Every person's calling lies in spiritual activity, in the constant search for truth and the meaning of life. Make coarse, animal-like labor unnecessary for them, let them feel free, and then you will see what a mockery these books and medicine chests are. Once a person realizes their true calling, only religion, science, and art can satisfy them, not these trifles."<br><br>Anton Pavlovich Chekhov, <i>The House with the Mezzanine</i></h2>
</div>

<div id="page6" class="pagee">
    <h1>Work is a central part of our lives. It is something we do almost every day, for much of the day, for decades on end. Because it is so central, looking closely at how much time we spend working can tell us a lot about our lives and the societies we live in.<br><br>As <img src="https://ourworldindata.org/owid-logo.svg" id="owid" width="30" height="20" /> Our world in Data says, In many countries today, people work much less than in the past 150 years. Working less means being able to spend time becoming more educated or simply enjoying leisure time.<br><br>This is substantial progress, but there are still huge inequalities across and within countries, and progress still to make. Taking my home country, <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Flag_of_the_People%27s_Republic_of_China.svg/125px-Flag_of_the_People%27s_Republic_of_China.svg.png" id="cn" width="30" height="22" /> China, as an example, although the country has labor laws, they are in name only. Overtime is very common in <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Flag_of_the_People%27s_Republic_of_China.svg/125px-Flag_of_the_People%27s_Republic_of_China.svg.png" id="cn" width="30" height="20" /> China, which is also Developing countries and developed countries are significantly lagging behind. But relying solely on the efforts of one or two people cannot change anything. Therefore, a consensus must be formed among the whole society, or even all mankind, to change this phenomenon.<br><br>Although many people are unwilling to admit it, the essential operating logic of this world is the <i>LAW OF THE JUNGLE</i>. Covering this core operating logic are various sugar-coatings promoted by politicians, which have different names in different eras. We are used to all kinds of power struggles, all kinds of pan-politicization, and all kinds of populism during the contraction period of the economic cycle, but we still need to forge ahead. In this context, a country that can have a diverse culture, respect the weak, respect women, and be tolerant enough will be respected by more people. Please follow me below.<br><br>Newton said: "If I have seen farther than others, it is because I stand on the shoulders of giants." This is how science should work. Those who want to understand the world should be able to stand on the shoulders of those who have gone before. Therefore, I used the data on Our world in Data to visualize the working hours of workers around the world. My work is equivalent to a preliminary work, but we can do some more in-depth research based on this work. For example, discuss why many countries can create high per capita GDP (such as <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Flag_of_Denmark.svg/225px-Flag_of_Denmark.svg.png" id="dk" width="30" height="20" />
Denmark) and have high labor productivity in relatively short working hours. This will be valuable.</h1>
</div>

<div id="page8" class="pagee">
    <h1>BASIC STATS</h1>
    <h2>Since these datasets are already very standardized, almost no data preprocessing is required.<br><br>Dataset Statistics and Key Points from Exploratory Data Analysis:<br><br><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Microsoft_Excel_Logo_%282013-2019%29.svg/2048px-Microsoft_Excel_Logo_%282013-2019%29.svg.png" id="csv" width="30" height="30" /> Annual Working Hours per Worker:<br>This dataset provides a detailed look at the average annual working hours per worker across various countries and over multiple years. Summary statistics reveal the average, median, and range of working hours, showing significant differences between countries. The data might indicate trends such as decreasing working hours in industrialized countries or highlight differences between economic sectors.<br><br><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Microsoft_Excel_Logo_%282013-2019%29.svg/2048px-Microsoft_Excel_Logo_%282013-2019%29.svg.png" id="csv" width="30" height="30" /> Annual Working Hours vs GDP per Capita:<br>This dataset links working hours with GDP per capita, offering insights into the economic productivity and labor input across different regions. The exploratory analysis could explore correlations between GDP per capita and working hours, potentially revealing how economic prosperity affects labor practices. A scatter plot of GDP versus working hours would typically show if higher productivity correlates with fewer working hours.<br><br><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Microsoft_Excel_Logo_%282013-2019%29.svg/2048px-Microsoft_Excel_Logo_%282013-2019%29.svg.png" id="csv" width="30" height="30" /> Productivity vs Annual Hours Worked:<br>Examining the relationship between productivity and annual working hours offers insights into efficiency dynamics within economies. Analysis might show whether shorter working hours correlate with higher productivity, supporting theories about work-life balance and its impact on output. Correlation plots and trend lines could be used to demonstrate these relationships over time and across different economies.</h2>
</div>

<div id="page9" class="pagee">
    <h1>DATA ANALYSIS</h1>
    <h2><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Microsoft_Excel_Logo_%282013-2019%29.svg/2048px-Microsoft_Excel_Logo_%282013-2019%29.svg.png" id="csv" width="30" height="30" /> 1. Annual Working Hours per Worker<br><br>Summary Statistics:<br>Count: There are 3,470 data points in the dataset.<br>Mean: The average annual working hours per worker across all entries is approximately 2005 hours.<br>Standard Deviation: There is a variation of about 304 hours around the mean, indicating a considerable spread in annual working hours across different data entries.<br>Minimum: The shortest annual working hours recorded are about 1354 hours.<br>Maximum: The longest annual working hours recorded are 3483 hours.<br>These statistics indicate a significant range between the minimum and maximum working hours, suggesting diverse working conditions across different countries or regions. The data points to potential differences in labor laws, economic conditions, or cultural norms influencing work hours.<br><br><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Microsoft_Excel_Logo_%282013-2019%29.svg/2048px-Microsoft_Excel_Logo_%282013-2019%29.svg.png" id="csv" width="30" height="30" /> 2. Annual Working Hours vs GDP per Capita<br><br>Correlation Analysis:<br>The correlation coefficient between annual working hours per worker and GDP per capita is approximately -0.581. This suggests a moderate inverse relationship, meaning as GDP per capita increases, annual working hours tend to decrease.<br>This inverse correlation might imply that higher economic output per person is associated with more efficient work or shorter hours, possibly due to higher labor productivity or more advanced technology.<br><br><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Microsoft_Excel_Logo_%282013-2019%29.svg/2048px-Microsoft_Excel_Logo_%282013-2019%29.svg.png" id="csv" width="30" height="30" /> 3. Productivity vs Annual Hours Worked<br><br>Correlation Analysis:<br>The correlation between annual working hours and productivity (output per hour worked) is approximately -0.690. This strong negative correlation further supports the notion that longer working hours are generally not associated with higher productivity.<br>This result suggests that economies with higher productivity tend to have shorter working hours, possibly due to more efficient utilization of labor and better technology.<br>
</h2>
</div>

<div id="page10" class="pagee">
    <h1>WHICH GENRE OF DATA STORY DID I USE?</h1>
    <h2><b><img src="assets/img/histogram.png" id="tool" width="30" height="30" /> Visual Narrative Tools Used:</b><br><br>Visual Structuring:<br><br>Consistent Visual Platform: Your visualizations maintain a uniform style across the webpage. This helps users quickly orient themselves and understand the flow of information.<br><br>Ordering: The narrative is clearly structured with a linear progression that's guided by prominently displayed titles and navigational anchors on the right side of the screen. These anchors facilitate easy browsing through different sections of information, enhancing the user's experience and comprehension.<br><br>Highlighting:<br><br>Feature Distinction: Specific colors or markers highlight key data points in the visualizations, drawing attention to important trends or differences.<br><br>Motion: If any animations are used, particularly in time-lapse visualizations or dynamic changes in the maps, they focus attention and enhance understanding of data changes over time.<br><br>Transition Guidance:<br>Object Continuity: Ensuring that visual elements have continuity across different states of data presentation helps maintain narrative flow and aids comprehension during transitions between various data points or time periods.<br><br><img src="assets/img/mouth.png" id="tool" width="40" height="30" /> <b>Narrative Structure Tools Used:</b><br><br>Ordering:<br>User-directed Path: The navigational structure allows users to progress through the narrative linearly but also offers some control over the pace and order of the exploration. This setup ensures that while there is a clear narrative direction, users also feel engaged through interactive exploration.<br><br>Interactivity:<br>Filtering/Selection/Search: Users can interact with the visualizations by selecting different years to view changes in work hours. This interactivity not only makes the narrative more engaging but also allows for a personalized exploration of the data.<br><br>Hover Highlighting/Details-on-demand: Providing additional information on hover, such as tooltips in visualizations, gives users immediate access to more detailed data about specific points or areas, enriching their understanding and interaction with the content.<br><br>Messaging:<br>Captions/Headlines: The use of descriptive captions and headlines helps to clarify the data and story for the viewer, ensuring that the key messages are effectively communicated.<br><br>Annotations: Annotations explain significant data points or events in the visualizations, adding depth and context to the narrative and helping users to understand complex information more easily.</h2>
</div>
...
<div id="page11" class="pagee">
    ...
    <img src="assets/img/Annual working hours vs. labor productivity, 2019.png" id="v3"/>
</div>
...
<div id="page15" class="pagee">
    <h2>REFERENCE</h2><br><br><br><h3>Charlie Giattino and Esteban Ortiz-Ospina (2020) - “Are we working more than ever?” Published online at OurWorldInData.org. Retrieved from: 'https://ourworldindata.org/working-more-than-ever' [Online Resource]</h3><h3><br><br>Charlie Giattino, Esteban Ortiz-Ospina and Max Roser (2020) - “Working Hours” Published online at OurWorldInData.org. Retrieved from: 'https://ourworldindata.org/working-hours' [Online Resource]</h3><br><br><h3>Denmark.dk (n.d.). Work-life balance: The key to the most efficient workers. Retrieved from https://denmark.dk/society-and-business/work-life-balance [Online Resource].</h3><br><br><h3>Rui Tang (2019). Why are the Nordic countries so rich? Retrieved from https://www.zhihu.com/question/327865315/answer/2175229393 [Online Resource].</h3><br><br><h2>POWERED BY</h2><a href="https://copilot.microsoft.com/"><img src="assets/img/Copilot-Logo.png"  id="Copilot" style="width: 12%; height: auto; object-fit: contain;" alt="Copilot"></a><a href="https://chatgpt.com/"><img src="assets/img/ChatGPT-Logo.png" id="GPT" style="width: 12%; height: auto; object-fit: contain;" alt="GPT-4"></a><a href="https://dashboard.heroku.com/"><img src="assets/img/heroku.png"  id="Heroku" style="width: 14%; height: auto; object-fit: contain;" alt="Heroku"></a>
    <h2>DATA SET FROM</h2><a href="https://ourworldindata.org/working-hours#introduction"><img src="https://ourworldindata.org/owid-logo.svg"  id="owidd" style="width: 14%; height: auto; object-fit: contain;" alt="OurWorldinData"/></a>
